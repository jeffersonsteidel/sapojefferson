...
<body>
	<f:view>
		...
		<center>
			<a4j:form id="form">
				<rich:panel header="LISTAR UNIDADE" style="width: 100%; left: 100%;">

					<rich:dataTable id="listarUnidade"
						value="#{unidadeController.unidadeList}" var="list"
						columnClasses="center" rows="20" reRender="ds"
						rendered="#{not empty unidadeController.unidadeList}">
						...
						<rich:column width="50px">
							...
							<a4j:commandLink action="#{unidadeController.editar}"
								reRender="listarUnidade" ajaxSingle="true">
						...
						<tbody>
							<tr>
								<td align="center" width="50%"><a4j:commandButton
										...
										action="#{unidadeController.excluir}"
