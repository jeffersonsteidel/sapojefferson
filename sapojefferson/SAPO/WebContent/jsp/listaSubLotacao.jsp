...
<body>
	<f:view>
		...
		<center>
			<a4j:form id="form">
				<rich:panel header="LISTAR SUB LOTAÇÃO"
					style="width: 100%; left: 100%;">

					<rich:dataTable id="listarSubLotacoes"
						value="#{subLotacaoController.subLotacaoList}" var="list"
						columnClasses="center" rows="20" reRender="ds"
						rendered="#{not empty subLotacaoController.subLotacaoList}">
						...
						<rich:column width="400px" sortBy="#{list.lotacao.descricao}"
						...
						<rich:column width="50px">
							...
							<a4j:commandLink action="#{subLotacaoController.editar}"
								reRender="listarSubElementos" ajaxSingle="true">
								<h:graphicImage value="../images/edit.gif" style="border:0"
									width="20" height="18" id="editar" />
								<f:setPropertyActionListener value="#{list}"
									target="#{subLotacaoController.subLotacao}" />
							</a4j:commandLink>
						...
						<tbody>
							<tr>
								<td align="center" width="50%"><a4j:commandButton
										...
										action="#{subLotacaoController.excluir}"
