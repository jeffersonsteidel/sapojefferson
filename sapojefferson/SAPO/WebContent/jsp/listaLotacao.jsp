...
<body>
	<f:view>
		...
		<center>
			<a4j:form id="form">
				<rich:panel header="LISTAR LOTAÇÕES"
					style="width: 100%; left: 100%;">
					<rich:dataTable id="listarLotacao"
						...
						<rich:column width="50px">
							...
							<a4j:commandLink action="#{lotacaoController.editarLotacao}"
								reRender="listarLotacao" ajaxSingle="true">
						...
						<tbody>
							<tr>
								<td align="center" width="50%"><a4j:commandButton
										...
										action="#{lotacaoController.excluir}"
