...
<body>
	<f:view>
		...
		<a4j:form id="form">
			<center>
				<rich:panel header="LANÇAR EXECUTADO"
					...
					<rich:dataTable id="listarReplanejamento"
						...
						<rich:column width="20px" sortBy="#{list.vlrExecutadoString}">
							<f:facet name="header">
								<h:outputText value="Executado" />
							</f:facet>
							<h:inputText onkeypress="mascara(this,moeda2);" id="campo"
								value="#{list.vlrExecutadoString}" size="10" maxlength="11">
							</h:inputText>
						</rich:column>
					</rich:dataTable>
					...
					<a4j:commandButton id="salvar" value="Salvar"
						rendered="#{not empty replanejamentoController.replanejamentoList}"
						action="#{replanejamentoController.salvar}" reRender="form" />
				</rich:panel>
			</center>
		</a4j:form>
	</f:view>
