...
<body>
	<f:view>
		...
		<a4j:form id="form">
			<center>
				<rich:panel header="APROVAR PRIORIDADES DE MATERIAL / SERVIÇO"
						...
						<rich:column width="20px" sortBy="#{list.prioridade}">
							...
							<h:inputText onkeypress="mascara(this,soNumeros);" id="campo"
								...
								<a4j:support event="onblur"
									action="#{materialController.numeroExiste2Aprovar}"
									ajaxSingle="true" reRender="messages, salvar, form">
					...
					<h:panelGrid columns="2"
						rendered="#{not empty materialController.materialList}">
						<a4j:commandButton value="Alterar Prioridades" id="salvar"
							disabled="#{!materialController.botaoSalvar}"
							rendered="#{usuarioController.usuarioAutenticado.subLotacao.lotacao.codigo eq materialController.material.subLotacao.lotacao.codigo}"
							action="#{materialController.salvarPrioridadesAprovador}"
							reRender="form">
							<f:setPropertyActionListener value="#{list}"
					...
					<h:panelGrid columns="2"
						rendered="#{not empty materialController.materialList}">
						<a4j:commandButton value="Aprovar" id="aprovar"
							action="#{materialController.aprovar}" reRender="massages">
							<f:setPropertyActionListener
								value="#{materialController.material}"
								target="#{materialController.material}" />
						</a4j:commandButton>
					</h:panelGrid>
